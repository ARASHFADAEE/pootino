...
<form method="POST" action="{{ $editing ? route('ads.update', $ad) : route('ads.store') }}" class="space-y-4">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
            <label class="mb-1 block text-sm font-semibold text-slate-700">محل خدمت فعلی (استان)</label>
        ...
        <div>
            <label class="mb-1 block text-sm font-semibold text-slate-700">محل درخواستی (استان)</label>
        ...
        <div>
            <label class="mb-1 block text-sm font-semibold text-slate-700">ارگان</label>
